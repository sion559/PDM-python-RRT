...
class Quadcopter():
    ...
    def __init__(self,quads,gravity=9.81,b=0.0245):
        ...
        for key in self.quads:
            ...
            ixx=((2*self.quads[key]['weight']*self.quads[key]['r']**2)/5)+(2*self.quads[key]['motorWeight']*self.quads[key]['L']**2)
            iyy=ixx
            izz=((2*self.quads[key]['weight']*self.quads[key]['r']**2)/5)+(4*self.quads[key]['motorWeight']*self.quads[key]['L']**2)
